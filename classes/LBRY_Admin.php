...
class LBRY_Admin
{
    ...
    */
    public function page_init()
    {
        ...
        //     'lbry_channel_settings',
        //     //array( $this, 'sanitize_channel_create' )
        // );
    ...
    */
    ...
    // public function sanitize_channel_create() {
    //     //$new_input = (array) get_option( 'lbry_channel_settings' );
    //     if ( isset( $_POST['lbry_new_channel'] ) ) {
    //         $channel = $_POST['lbry_new_channel'];
    //         $channel = str_replace( '@', '', $channel );
    //         $clean_input['lbry_new_channel'] = sanitize_user( $channel );
    //         //return $new_input['lbry_new_channel'];
    //     }
    //     if ( isset( $_POST['lbry_channel_bid_amount'] ) ) {
    //         $channel_bid_amount = $_POST['lbry_channel_bid_amount'];
    //         $clean_input['lbry_channel_bid_amount'] = number_format( floatval( $channel_bid_amount ), 3, '.', '' );
    //     }
    //     // return $clean_input;
    //     //update_option( 'lbry_channel_settings', $clean_input );
    // }
    ...
    */
    ...
    //{
    //     //$options = get_option( 'lbry_channel_settings' );
    //     printf(
    //       '<input type="text" id="' . esc_attr('%1$s') . '" name="' . esc_attr('%1$s') . '" value="' . esc_attr('%3$s') . '" placeholder="your-new-channel" required>',
    //       'lbry_new_channel',
    //       'lbry_channel_settings',
    //       $_POST['lbry_new_channel']
    //     );
    // }
    ...
    //     //$options = get_option( 'lbry_channel_settings' );
    //     printf(
    //         '<input type="number" step="0.001" min="0.001" id="' . esc_attr('%1$s') . '" name="' . esc_attr('%1$s') . '" value="' . esc_attr('%3$.3f') . '" required>',
    //         'lbry_channel_bid_amount',
    //         'lbry_channel_settings',
    //         $_POST['lbry_channel_bid_amount']
    //     );
    // }
